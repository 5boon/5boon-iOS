...
final class SignUpFirstViewController: BaseViewController, ReactorKit.View, Pure.FactoryModule {
    ...
    init(reactor: Reactor,
         pushSecondStepScreen: @escaping () -> SignUpSecondViewController) {
        defer { self.reactor = reactor }
        self.pushSecondStepScreen = pushSecondStepScreen
        super.init()
    }
    ...
    override func setupConstraints() {
        ...
        passwordTextField.snp.makeConstraints { make in
            ...
            make.right.equalTo(-Metric.leftRightPadding)
            make.height.equalTo(Metric.fieldHeight)
            make.top.equalTo(idTextField.snp.bottom).offset(Metric.textFieldTop)
        }
        
        nextButton.snp.makeConstraints { make in
            make.top.equalTo(passwordTextField.snp.bottom).offset(Metric.buttonTop)
            make.left.equalTo(Metric.leftRightPadding)
            make.right.equalTo(-Metric.leftRightPadding)
        ...
        duplicateLabel.snp.makeConstraints { make in
            make.top.equalTo(passwordTextField.snp.bottom).offset(Metric.duplicateTop)
            make.right.equalTo(-Metric.leftRightPadding)
        }
